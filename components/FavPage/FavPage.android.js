...
var FavPage = React.createClass({
    ...
    render             : function () {
        ...
        if (this.props.pageData.get('isLoading')) {
            mainView = <ProgressBarAndroid style={{marginTop: 30}}/>
        }
            ...
            mainView = (
                <View
                    ...
                    <TouchableNativeFeedback
                        style={{height: 40,width: 100,flexDirection: 'column', justifyContent: 'center', alignItems: 'center', backgroundColor: Constants.color.TOUCH_UNDERLAY_BLUE}}
